...
function Nav() {
  ...
  return (
    <div className="w-[100vw] h-[70px] bg-[#ecfafaec] z-10 fixed top-0 flex items-center justify-between px-[30px] shadow-md shadow-black">
      <div className="w-[20%] lg:w-[30%] flex item-center justify-start gap-[10px]">
        <img alt="" className="w-[30px]" src={vcartLogo} />
      ...
      <div className="w-[30%] flex items-center justify-end gap-[20px]">
        ...
        {!userData && (
          <FaUserAlt className="w-[29px] h-[29px] text-[#000000] cursor-pointer" onClick={() => {
        ...
        <FiShoppingCart className="w-[29px] h-[29px] text-[#000000] cursor-pointer hidden md:block" />
        <p className="hidden md:block absolute w-[18px] h-[18px] items-center justify-center bg-black px-[5px] py-[2px] text-white rounded-full text-[9px] top-[10px] right-[23px] hidden">
          10
        </p>
      </div>
      {showSearch && (
      ...
      {showProfile && 
        <div className="absolute w-[220px] h-[150px] bg-[#000000d7] top-[110%] right-[4%] border-[#aaa9a9] rounded-[10px] z-10 ">
          <ul className="w-[100%] h-[100%] flex flex-col items-start justify-around py-[10px] text-[17px] text-[white]">
            {!userData && (
              <li
      ...
      <div className="w-[100vw] h-[90px] flex text-[12px] items-center justify-between px-[20px] fixed bottom-0 left-0 bg-[#191818] md:hidden">
        ...
        <button className="text-[white] flex items-center justify-center flex-col gap-[2px]"><GrCart   className="w-[25px] h-[25px] text-[white] md:hidden" /> Cart</button>
